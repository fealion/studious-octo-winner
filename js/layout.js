...
<div class="header-image">
          <img src="https://raw.githubusercontent.com/fealion/studious-octo-winner/refs/heads/main/images/larp/title%402x.png" alt="" />
        </div>
...
function footerHTML() {
  ...
  return `
      ...
      <footer>
            <div> ⊗ 2026 larpy Huang (<a href="https://www.youtube.com/@LarpyBH">Larpy's channal</a>)and Miclarp Huang</div>
			<div></div>
      </footer>`;
}
